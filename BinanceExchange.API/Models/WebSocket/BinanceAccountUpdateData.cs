...
namespace BinanceExchange.API.Models.WebSocket
{
    ...
    public class BinanceAccountUpdateData: IWebSocketResponse
    {
        ...
        {
            return string.Format("[BinanceAccountUpdateData: EventType={0}, EventTime={1}, M={2}, t={3}, B={4}, S={5}, T={6}, W={7}, D={8}, Balances={9}]", EventType, EventTime, M, t, B, S, T, W, D, Balances);
        }
    }
}