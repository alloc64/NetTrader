...
namespace BinanceExchange.API.Models.WebSocket
{
    ...
    public class BinanceAggregateTradeData : ISymbolWebSocketResponse
    {
        ...
        {
            return string.Format("[BinanceAggregateTradeData: EventType={0}, EventTime={1}, Symbol={2}, AggregateTradeId={3}, Price={4}, Quantity={5}, FirstTradeId={6}, LastTradeId={7}, TradeTime={8}, WasBuyerMaker={9}]", EventType, EventTime, Symbol, AggregateTradeId, Price, Quantity, FirstTradeId, LastTradeId, TradeTime, WasBuyerMaker);
        }
    }
}